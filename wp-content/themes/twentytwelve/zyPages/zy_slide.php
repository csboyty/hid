...
<article id="zy_content" class="zy_hidden zy_uploader">
    ...
    <section id="zy_section_left" class="zy_uploader_column_left">
        ...
        <script type="text/template" id="zy_complete_tpl">
            <li class="zy_media_list ${classString}" data-zy-media-type="${media_type}" data-zy-media-id='${media_id}' href="${iframe_src}" >
                <img class="zy_small_thumb" src="${thumb_src}">
                <span title='${filename}' draggable="true" class="zy_media_filename">${filename}</span>
                <span class="zy_media_delete"></span>
            </li>
        </script>
